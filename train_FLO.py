...
parser.add_argument('--gen_nepoch', type=int, default=300, help='number of epochs to train for')
...
parser.add_argument('--nSample', type=int, default=3000, help='number features to generate per class')
parser.add_argument('--num_coupling_layers', type=int, default=5, help='number features to generate per class')

parser.add_argument('--disp_interval', type=int, default=200)
parser.add_argument('--save_interval', type=int, default=10000)
parser.add_argument('--evl_interval',  type=int, default=500)
parser.add_argument('--manualSeed', type=int, default=6152, help='manual seed') #default=6152 12100
...
parser.add_argument('--cons',    type=float, default=9, help='weight of the prototype loss')
...
def train():
    ...
    out_dir = 'out/{}/mask-{}_c-{}_ns-{}_wd-{}_lr-{}_nS-{}_bs-{}_ps-{}'.format(opt.dataset, opt.dropout, opt.prototype,
    ...
    for it in range(start_step, opt.niter+1):
        ...
        if it % opt.evl_interval == 0 and it > 2000:
            ...
            cls = classifier2.CLASSIFIER(opt, train_X, train_Y, dataset,  dataset.test_seen_feature,  dataset.test_unseen_feature,
                                dataset.ntrain_class + dataset.ntest_class, True, opt.classifier_lr, 0.5, 30, 1000, True)
